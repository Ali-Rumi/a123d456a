...
class TradingStrategy:
    ...
    def run_bnb_long(self):
        try:
            subprocess.Popen(["python", "ada_long.py"])
            print("Running ada_long.py")
        except Exception as e:
            print(f"Error running ada_long.py: {e}")

    def run_bnb_short(self):
        try:
            subprocess.Popen(["python", "ada_short.py"])
            print("Running ada_short.py")
        except Exception as e:
            print(f"Error running ada_short.py: {e}")
